...
if !gameOver {
	...
	draw_text(64, 170, string("Targets hit: ") + string(enemies_killed));
	draw_text(64, 190, string("Average Time to kill: ") + string(average_time_to_kill / 1000));
	draw_text(64, 210, string("Time Elapsed: ") + string((current_time - time_elapsed) / 1000) + string(" seconds"));
	...
	draw_set_valign(fa_top)
	draw_text(x_camera, 75, "Game Over")
